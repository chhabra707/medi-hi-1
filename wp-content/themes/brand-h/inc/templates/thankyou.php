...
<section style="max-width:635px">
    <div class="mx-auto w-full lg:mt-20 mt-0" >
        <img src="<?php bloginfo('template_directory') ?>/img/thankyou.jpg" alt="" class="mx-auto">
        <div class="text-center my-20" style="font-size:42px;">Thank you</div>
        <div class="">
            <div class="thank-2" >An answer will be given within 24hours.</div>
            <div class="divide-y divide-gray-400 lg:px-40 px-32 mt-5">
